...
CREATE TABLE `raca` (
  ...
  `nome_br` varchar(70) NOT NULL,
  `nome_eng` varchar(70) NOT NULL,
  `paisOrigem` varchar(2000) NOT NULL,
  `uso` varchar(70) NOT NULL,
  `temperamento` varchar(45) NOT NULL,
  `breveHistoria` varchar(2000) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `raca` VALUES (65,'  ','  ','  ','  ','  ','  '),(66,' oi ',' oi ',' oi ','oi  ',' oi ',' oi '),(67,'Luan','leao','Brasil,',',',',',',,,'),(68,'Luan','leao','Brasil,',',',',',',,,');
